...
#SBATCH -o experiments/2026-05-08_robust_calibration_window_sparse/slurm_logs/job-%A_%a.out
#SBATCH -e experiments/2026-05-08_robust_calibration_window_sparse/slurm_logs/job-%A_%a.err

EXPERIMENT="experiments/2026-05-08_robust_calibration_window_sparse"

PROJECT_ROOT="$SLURM_SUBMIT_DIR"
EXP_DIR="$PROJECT_ROOT/$EXPERIMENT"

echo "===== Robust Calibration Window Sweep (Sparse) ====="
