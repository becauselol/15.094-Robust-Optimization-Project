...
#SBATCH -o experiments/2026-04-30_sparse_subsample_40/slurm_logs/job-%A_%a.out
#SBATCH -e experiments/2026-04-30_sparse_subsample_40/slurm_logs/job-%A_%a.err

EXPERIMENT="experiments/2026-04-30_sparse_subsample_40"
